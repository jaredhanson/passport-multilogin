...
Strategy.prototype.authenticate = function(req, options) {
  ...
  var self = this
    , s = (req.state && req.state.selectedSession) || (req.query && req.query.s) // TODO: select from body, params and state as well
    , suser, smethods;
  ...
  if (s === undefined && options.multi) {
    ...
    (function iter(i) {
      ...
      if (arity == 3) {
        self._deserializeUser(suser, req, deserialized);
      } else {
        self._deserializeUser(suser, serialized);
      }
    })(0);
