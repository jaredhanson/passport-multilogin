...
Strategy.prototype.authenticate = function(req, options) {
  ...
  if (i === undefined && options.multi) {
    ...
    var keys = Object.keys(req.session[this._key].sessions)
      , users = []
      , infos = [];
    ...
    (function iter(i) {
      ...
      obj = req.session[self._key].sessions[key];
  ...
  var self = this, 
      suser;
  if (req.session[this._key] && req.session[this._key].sessions && req.session[this._key].sessions[h]) {
    suser = req.session[this._key].sessions[h].user;
  }
